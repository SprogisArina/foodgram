# Generated by Django 3.2.3 on 2025-05-28 10:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(related_name='recipes', through='api.TagRecipe', to='api.Tag', verbose_name='Тэги'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(('user', django.db.models.expressions.F('following')), _negated=True), name='self-following'),
        ),
        migrations.AddConstraint(
            model_name='favorite',
